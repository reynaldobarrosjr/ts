								...
								<select name="<?php echo esc_attr( $value['id'] ); ?>" id="<?php echo esc_attr( $value['id'] ); ?>">
									<?php foreach ( $value['options'] as $option ) { ?>
										<?php 
											...
											if ( ( stripslashes( get_option($value['id']) ) == trim( stripslashes( $option ) ) ) || ( ! get_option( $value['id'] ) && isset( $value['std'] ) && stripslashes( $option ) == stripslashes( $value['std'] ) ) )
												$et_select_active = ' selected="selected"';
										?>
										<option<?php echo esc_html( $et_select_active ); ?>><?php echo esc_html( trim( $option ) ); ?></option>
									<?php } ?>
								</select>
